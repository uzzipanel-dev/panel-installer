...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/uzzipanel-dev/panel-installer/"
...
while [ "$done" == false ]; do
  options=(
    "Install the Panel - Standard installation of the Uzzi Panel"
    "Install Wings - Standard installation of the Uzzi Wings"
