...
#                                                                                    #
# https://github.com/uzzi-installer/uzzi-installer/blob/Production/LICENSE.md  #
#                                                                                    #
# This script is not associated with the official Uzzi Project.                   #
# https://github.com/uzzi-installer/uzzi-installer                             #
#                                                                                    #
######################################################################################
...
# Uzzi versions
export UZZI_PANEL_VERSION=""
export UZZI_WINGS_VERSION=""
...
export WINGS_DL_BASE_URL="https://github.com/uzzipanel-dev/wings/releases/download/wings/wings.tar.gz"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/uzzi-installer/uzzi-installer"}
...
welcome() {
  ...
  print_brake 70
  output "Uzzi Panel installation script @ $SCRIPT_RELEASE"
  output ""
  ...
  output "https://github.com/uzzi-installer/uzzi-installer"
  output ""
  output "This script is not associated with the official Uzzi Project."
  output ""
  output "Running $OS version $OS_VER."
  if [ "$1" == "panel" ]; then
    output "Latest uzzipanel-dev/panel is $UZZI_PANEL_VERSION"
  elif [ "$1" == "wings" ]; then
    output "Latest uzzipanel-dev/wings is $UZZI_WINGS_VERSION"
  fi
  print_brake 70
}
...
get_latest_versions() {
  ...
  UZZI_PANEL_VERSION=$(get_latest_release "uzzipanel-dev/panel")
  UZZI_WINGS_VERSION=$(get_latest_release "uzzipanel-dev/wings")
}
